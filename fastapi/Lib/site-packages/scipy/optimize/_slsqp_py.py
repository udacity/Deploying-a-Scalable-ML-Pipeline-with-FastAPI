...
def approx_jacobian(x, func, epsilon, *args):
    ...
    jac = approx_derivative(
        func, x, method="2-point", abs_step=epsilon, args=args
    )
    ...
    **unknown_options
    ...
    for ic, con in enumerate(constraints):
        ...
        try:
            ...
            raise TypeError(
                "Constraints must be defined using a " "dictionary."
            ) from e
        ...
        cons[ctype] += (
            {"fun": con["fun"], "jac": cjac, "args": con.get("args", ())},
        )
