...
def minimize(
    ...
    **Custom minimizers**
    ...
    if (
        ...
        warn(
            "Method %s cannot handle bounds." % method,
            RuntimeWarning,
            stacklevel=2,
        )
    # - return_all
    ...
    if meth == "nelder-mead":
        res = _minimize_neldermead(
            fun, x0, args, callback, bounds=bounds, **options
        )
    elif meth == "powell":
        ...
        res = _minimize_newtoncg(
            fun, x0, args, jac, hess, hessp, callback, **options
        )
    elif meth == "l-bfgs-b":
        ...
        res = _minimize_cobyqa(
            fun, x0, args, bounds, constraints, callback, **options
        )
    elif meth == "slsqp":
        res = _minimize_slsqp(
            fun,
