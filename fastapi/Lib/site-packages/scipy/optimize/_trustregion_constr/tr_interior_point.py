...
class BarrierSubproblem:
    ...
    def stop_criteria(
        ...
        if self.global_stop_criteria(
            ...
            g_cond = (
                optimality < self.tolerance
                and constr_violation < self.tolerance
            )
...
def tr_interior_point(
    ...
    while True:
        ...
        # Update parameters
        trust_radius = max(
            initial_trust_radius, TRUST_ENLARGEMENT * state.tr_radius
        )
