...
def _minimize_trustregion_constr(
    ...
    if bounds is not None:
        ...
        bounds = Bounds(
            modified_lb, modified_ub, keep_feasible=bounds.keep_feasible
        )
    ...
    if bounds is not None:
        ...
        prepared_constraints.append(
            PreparedConstraint(bounds, x0, sparse_jacobian)
        )
    ...
    canonical_all = [
        CanonicalConstraint.from_PreparedConstraint(c)
        for c in prepared_constraints
    ]
    ...
    if len(canonical_all) == 0:
        ...
        canonical = CanonicalConstraint.concatenate(
            canonical_all, sparse_jacobian
        )
