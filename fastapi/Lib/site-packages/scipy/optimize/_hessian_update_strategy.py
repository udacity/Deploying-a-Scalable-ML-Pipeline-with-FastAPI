...
class HessianUpdateStrategy:
    ...
    def dot(self, p):
        ...
        """
        raise NotImplementedError(
            "The method ``dot(p)``" " is not implemented."
        )
    ...
    def get_matrix(self):
        ...
        """
        raise NotImplementedError(
            "The method ``get_matrix(p)``" " is not implemented."
        )
...
class BFGS(FullHessianUpdateStrategy):
    ...
    def __init__(
        ...
        if exception_strategy == "skip_update":
            ...
            raise ValueError(
                "`exception_strategy` must be 'skip_update' "
                "or 'damp_update'."
            )
...
class SR1(FullHessianUpdateStrategy):
    ...
    def _update_implementation(self, delta_x, delta_grad):
        ...
        if np.abs(denominator) <= self.min_denominator * norm(w) * norm(
            z_minus_Mw
        ):
            return
        # Update matrix
