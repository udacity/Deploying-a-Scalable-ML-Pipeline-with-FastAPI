...
class DifferentialEvolutionSolver:
        ...
        *,
        ...
        if isinstance(bounds, Bounds):
            self.limits = np.array(
                new_bounds_to_old(bounds.lb, bounds.ub, len(bounds.lb)),
                dtype=float,
            ).T
        else:
    ...
    def _result(self, **kwds):
        ...
        if self._wrapped_constraints:
            result.constr = [
                c.violation(result.x) for c in self._wrapped_constraints
            ]
    ...
    def _promote_lowest_energy(self):
        ...
        self.constraint_violation[[0, l], :] = self.constraint_violation[
            [l, 0], :
        ]
