...
class TestNewToOld:
    ...
    def test_individual_constraint_objects(self):
        ...
        cone.append(
            NonlinearConstraint(
                lambda x: [x[0] - x[1], x[1] - x[2]], 1.21, 1.21
            )
        )  # two same equalities
        cone.append(
            NonlinearConstraint(
        ...
        coni.append(
            NonlinearConstraint(
                lambda x: x[0] - x[1], 1.21, np.array([np.inf])
            )
        )
        ...
        coni.append(
            NonlinearConstraint(
                lambda x: [x[0] - x[1], x[1] - x[2]], 1.21, np.inf
            )
        ...
        cone.append(
            LinearConstraint(
                [[1, -1, 0], [0, 1, -1]], [1.21, -np.inf], [1.21, 1.4]
            )
        )
...
class TestNewToOldSLSQP:
    ...
    def test_warn_ignored_options(self):
        ...
        res = minimize(
            fun, x0, method=self.method, bounds=bnds, constraints=cons
        )
        ...
        cons.append(
            NonlinearConstraint(
                lambda x: x[0] ** 2, 2, np.inf, keep_feasible=True
            )
        )
        cons.append(
        ...
        cons.append(
            NonlinearConstraint(
                lambda x: x[0] ** 2, 2, np.inf, finite_diff_rel_step=42
            )
        )
