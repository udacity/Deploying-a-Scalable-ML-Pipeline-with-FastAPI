...
class TestScalarRootFinders:
    ...
    def _run_one_test(
        ...
        try:
            ...
            return (
                root,
                zeros.RootResults(nan, -1, -1, zeros._EVALUEERR, method),
                tc,
            )
...
class TestBracketMethods(TestScalarRootFinders):
    ...
    @pytest.mark.parametrize(
        "method", [zeros.bisect, zeros.ridder, zeros.toms748]
    )
...
class TestNewton(TestScalarRootFinders):
    ...
    def test_root_scalar_fail(self):
        ...
        with pytest.raises(ValueError, match=message):
            root_scalar(
                f1, method="halley", fprime=f1_1, x0=3, xtol=1e-6
            )  # no fprime2
        message = "fprime must be specified for halley"
        with pytest.raises(ValueError, match=message):
            root_scalar(
                f1, method="halley", fprime2=f1_2, x0=3, xtol=1e-6
            )  # no fprime
    ...
    def test_newton_combined(self):
        ...
        sol0 = root_scalar(
            f1, method="halley", x0=3, fprime=f1_1, fprime2=f1_2
        )
    ...
    def test_gh17570_defaults(self):
        ...
        res_secant_default = root_scalar(
            f1, method="secant", x0=3, x1=2, xtol=1e-6
        )
...
@pytest.mark.parametrize(
    "method", ["brentq", "brenth", "bisect", "ridder", "toms748"]
)
