...
class QAPCommonTests:
    ...
    def test_accuracy_3(self):
        ...
        # basic minimization
        res = quadratic_assignment(
            A, B, method=self.method, options={"rng": 0}
        )
        ...
        empty = np.empty((0, 0))
        res = quadratic_assignment(
            empty, empty, method=self.method, options={"rng": 0}
        )
        assert_equal(res.nit, 0)
    ...
    def test_unknown_options(self):
        ...
        def f():
            quadratic_assignment(
                A, B, method=self.method, options={"ekki-ekki": True}
            )
...
class TestFAQ(QAPCommonTests):
    ...
    def test_options(self):
        ...
        res = quadratic_assignment(
            A, B, options={"rng": 1, "P0": "randomized"}
        )
        assert_(11156 <= res.fun < 21000)
