...
class TestDualAnnealing:
    ...
    def test_max_reinit(self):
        assert_raises(
            ValueError, dual_annealing, self.weirdfunc, self.ld_bounds
        )
    ...
    def test_max_fun_ls(self):
        ret = dual_annealing(
            self.func, self.ld_bounds, maxfun=100, seed=self.seed
        )
    ...
    def test_maxiter(self):
        ret = dual_annealing(
            self.func, self.ld_bounds, maxiter=700, seed=self.seed
        )
        assert ret.nit <= 700
