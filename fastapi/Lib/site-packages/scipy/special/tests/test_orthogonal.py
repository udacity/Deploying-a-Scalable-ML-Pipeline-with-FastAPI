    ...
    def test_call(self):
        ...
        with np.errstate(all="ignore"):
            for pstr in poly:
                p = eval(pstr)
                assert_almost_equal(
                    p(0.315), np.poly1d(p.coef)(0.315), err_msg=pstr
                )
...
def test_roots_jacobi():
    ...
    vgq(
        rf(0.5, -0.5), ef(0.5, -0.5), wf(0.5, -0.5), -1.0, 1.0, 100, atol=2e-12
    )
...
def test_roots_gegenbauer():
    ...
    vgq(
        rootf(170.5), evalf(170.5), weightf(170.5), -1.0, 1.0, 5, atol=1.25e-13
    )
...
def test_roots_sh_chebyt():
    ...
    verify_gauss_quad(
        sc.roots_sh_chebyt, sc.eval_sh_chebyt, weightf, 0.0, 1.0, 5
    )
    verify_gauss_quad(
        sc.roots_sh_chebyt, sc.eval_sh_chebyt, weightf, 0.0, 1.0, 25
    )
    verify_gauss_quad(
        sc.roots_sh_chebyt,
        sc.eval_sh_chebyt,
...
def test_roots_sh_chebyu():
    ...
    verify_gauss_quad(
        sc.roots_sh_chebyu, sc.eval_sh_chebyu, weightf, 0.0, 1.0, 5
    )
    verify_gauss_quad(
        sc.roots_sh_chebyu, sc.eval_sh_chebyu, weightf, 0.0, 1.0, 25
    )
    verify_gauss_quad(
        sc.roots_sh_chebyu,
        sc.eval_sh_chebyu,
...
def test_roots_legendre():
    ...
    verify_gauss_quad(
        sc.roots_legendre, sc.eval_legendre, weightf, -1.0, 1.0, 5
    )
    verify_gauss_quad(
...
def test_roots_sh_legendre():
    ...
    verify_gauss_quad(
        sc.roots_sh_legendre, sc.eval_sh_legendre, weightf, 0.0, 1.0, 5
    )
    verify_gauss_quad(
...
def test_roots_laguerre():
    ...
    verify_gauss_quad(
        sc.roots_laguerre, sc.eval_laguerre, weightf, 0.0, np.inf, 5
    )
    verify_gauss_quad(
        sc.roots_laguerre,
        sc.eval_laguerre,
