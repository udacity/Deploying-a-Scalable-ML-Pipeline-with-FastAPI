...
class TestRecurrence:
    ...
    def test_sh_chebyt(self):
        self.check_poly(
            _ufuncs.eval_sh_chebyt, param_ranges=[], x_range=[0, 1]
        )

    def test_sh_chebyu(self):
        self.check_poly(
            _ufuncs.eval_sh_chebyu, param_ranges=[], x_range=[0, 1]
        )

    def test_legendre(self):
        self.check_poly(
            _ufuncs.eval_legendre, param_ranges=[], x_range=[-1, 1]
        )

    def test_sh_legendre(self):
        self.check_poly(
            _ufuncs.eval_sh_legendre, param_ranges=[], x_range=[0, 1]
        )
    ...
    def test_laguerre(self):
        self.check_poly(
            _ufuncs.eval_laguerre, param_ranges=[], x_range=[0, 100]
        )
