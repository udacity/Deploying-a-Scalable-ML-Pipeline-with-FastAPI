...
BOOST_TESTS = [
    ...
    data(
        betainc, "ibeta_int_data_ipp-ibeta_int_data", (0, 1, 2), 5, rtol=2e-14
    ),
    data(
        betainc,
        "ibeta_large_data_ipp-ibeta_large_data",
        (0, 1, 2),
        5,
        rtol=4e-10,
    ),
    ...
    data(
        btdtria, "ibeta_inva_data_ipp-ibeta_inva_data", (2, 0, 1), 3, rtol=5e-9
    ),
    data(
        btdtria_comp,
        "ibeta_inva_data_ipp-ibeta_inva_data",
        (2, 0, 1),
        4,
        rtol=5e-9,
    ),
    data(
        btdtrib, "ibeta_inva_data_ipp-ibeta_inva_data", (0, 2, 1), 5, rtol=5e-9
    ),
    data(
        btdtrib_comp,
        "ibeta_inva_data_ipp-ibeta_inva_data",
    ...
    data(
        binom,
        "binomial_large_data_ipp-binomial_large_data",
        (0, 1),
        2,
        rtol=5e-13,
    ),
    ...
    data(
        pdtrik,
        "poisson_quantile_ipp-poisson_quantile_data",
        (1, 0),
        2,
        rtol=3e-9,
    ),
    ...
    data(
        digamma, "digamma_root_data_ipp-digamma_root_data", 0j, 1, rtol=1e-15
    ),
    data(
        digamma, "digamma_small_data_ipp-digamma_small_data", 0, 1, rtol=1e-15
    ),
    data(
        digamma, "digamma_small_data_ipp-digamma_small_data", 0j, 1, rtol=1e-14
    ),
    ...
    data(
        ellipeinc_, "ellint_e2_data_ipp-ellint_e2_data", (0, 1), 2, rtol=1e-14
    ),
    ...
    data(
        expi, "expinti_data_double_ipp-expinti_data_double", 0, 1, rtol=1e-13
    ),
    ...
    data(
        gammainc,
        "igamma_small_data_ipp-igamma_small_data",
        (0, 1),
        5,
        rtol=5e-15,
    ),
    data(
        gammainc, "igamma_med_data_ipp-igamma_med_data", (0, 1), 5, rtol=2e-13
    ),
    data(
        gammainc, "igamma_int_data_ipp-igamma_int_data", (0, 1), 5, rtol=2e-13
    ),
    data(
        gammainc, "igamma_big_data_ipp-igamma_big_data", (0, 1), 5, rtol=1e-12
    ),
    data(
        gdtr_, "igamma_small_data_ipp-igamma_small_data", (0, 1), 5, rtol=1e-13
    ),
    ...
    data(
        gammaincc, "igamma_med_data_ipp-igamma_med_data", (0, 1), 3, rtol=2e-13
    ),
    data(
        gammaincc, "igamma_int_data_ipp-igamma_int_data", (0, 1), 3, rtol=4e-14
    ),
    data(
        gammaincc, "igamma_big_data_ipp-igamma_big_data", (0, 1), 3, rtol=1e-11
    ),
    data(
        gdtrc_,
        "igamma_small_data_ipp-igamma_small_data",
    ...
    data(
        gdtrib_, "igamma_inva_data_ipp-igamma_inva_data", (1, 0), 2, rtol=5e-9
    ),
    data(
        gdtrib_comp,
        "igamma_inva_data_ipp-igamma_inva_data",
        (1, 0),
        3,
        rtol=5e-9,
    ),
    ...
    data(
        iv,
        "bessel_i_data_ipp-bessel_i_data",
        (0, 1j),
        2,
        rtol=2e-10,
        atol=1e-306,
    ...
    data(
        iv, "bessel_i_int_data_ipp-bessel_i_int_data", (0, 1j), 2, rtol=2e-10
    ),
    data(
        ivp,
    ...
    data(
        jn, "bessel_j_int_data_ipp-bessel_j_int_data", (0, 1j), 2, rtol=1e-12
    ),
    data(
        jn,
        "bessel_j_large_data_ipp-bessel_j_large_data",
        (0, 1),
        2,
        rtol=6e-11,
    ),
    ...
    data(
        jv, "bessel_j_int_data_ipp-bessel_j_int_data", (0, 1j), 2, rtol=1e-12
    ),
    ...
    data(
        kv, "bessel_k_int_data_ipp-bessel_k_int_data", (0, 1j), 2, rtol=1e-12
    ),
    ...
    data(
        kvp,
        "bessel_k_prime_data_ipp-bessel_k_prime_data",
        (0, 1),
        2,
        rtol=7e-14,
    ),
    ...
    data(
        yvp,
        "bessel_yv_prime_data_ipp-bessel_yv_prime_data",
        (0, 1),
        2,
        rtol=4e-9,
    ),
    ...
    data(
        zeta_, "zeta_data_ipp-zeta_data", 0, 1, param_filter=(lambda s: s > 1)
    ),
    data(
        zeta_,
        "zeta_neg_data_ipp-zeta_neg_data",
        0,
        1,
    ...
    data(
        zeta_,
        "zeta_1_up_data_ipp-zeta_1_up_data",
        0,
        1,
        param_filter=(lambda s: s > 1),
    ),
    ...
    data(
        gammaincinv, "gamma_inv_data_ipp-gamma_inv_data", (0, 1), 2, rtol=1e-14
    ),
    data(
        gammaincinv,
    ...
    data(
        gammainccinv,
        "gamma_inv_data_ipp-gamma_inv_data",
        (0, 1),
        3,
        rtol=1e-14,
    ),
    ...
    data(
        gdtrix_comp, "gamma_inv_data_ipp-gamma_inv_data", (0, 1), 3, rtol=6e-15
    ),
    ...
    data(
        spherical_jn_,
        "sph_bessel_data_ipp-sph_bessel_data",
        (0, 1),
        2,
        rtol=1e-13,
    ),
    data(
        spherical_yn_,
        "sph_neumann_data_ipp-sph_neumann_data",
        (0, 1),
        2,
        rtol=8e-15,
    ),
    ...
    data(
        owens_t,
        "owens_t_large_data_ipp-owens_t_large_data",
        (0, 1),
        2,
        rtol=8e-12,
    ),
    ...
    data(
        elliprd, "ellint_rd_data_ipp-ellint_rd_data", (0, 1, 2), 3, rtol=5e-16
    ),
    ...
    data(
        elliprd, "ellint_rd_xxz_ipp-ellint_rd_xxz", (0, 1, 2), 3, rtol=6.5e-16
    ),
    data(elliprd, "ellint_rd_xyy_ipp-ellint_rd_xyy", (0, 1, 2), 3, rtol=6e-16),
    data(
        elliprf, "ellint_rf_data_ipp-ellint_rf_data", (0, 1, 2), 3, rtol=5e-16
    ),
    ...
    data(
        elliprg, "ellint_rg_xyy_ipp-ellint_rg_xyy", (0, 1, 2), 3, rtol=7.5e-16
    ),
...
GSL_TESTS = [
    ...
    data_gsl(
        mathieu_ce_rad, "mathieu_ce_se", (0, 1, 2), 3, rtol=1e-7, atol=1e-13
    ),
    data_gsl(
        mathieu_se_rad, "mathieu_ce_se", (0, 1, 2), 4, rtol=1e-7, atol=1e-13
    ),
    data_gsl(
        mathieu_mc1_scaled,
        "mathieu_mc_ms",
...
LOCAL_TESTS = [
    ...
    data_local(
        ellip_harm_2, "ellip", (0, 1, 2, 3, 4), 6, rtol=1e-10, atol=1e-13
    ),
    data_local(
        ellip_harm, "ellip", (0, 1, 2, 3, 4), 5, rtol=1e-10, atol=1e-13
    ),
