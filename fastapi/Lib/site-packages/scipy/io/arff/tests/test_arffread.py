...
class TestDateAttribute:
    ...
    def test_datetime_local_attribute(self):
        expected = np.array(
            [
                datetime.datetime(
                    year=1999, month=1, day=31, hour=0, minute=1
                ),
                datetime.datetime(
                    year=2004, month=12, day=1, hour=23, minute=59
                ),
                datetime.datetime(
                    year=1817, month=4, day=28, hour=13, minute=0
                ),
                datetime.datetime(
                    year=2100, month=9, day=10, hour=12, minute=0
                ),
                datetime.datetime(
                    year=2013, month=11, day=30, hour=4, minute=55
                ),
                datetime.datetime(
                    year=1631, month=10, day=15, hour=20, minute=4
                ),
            ],
            dtype="datetime64[m]",
        )
...
class TestRelationalAttribute:
    ...
    def test_data(self):
        dtype_instance = [
            ("attr_date", "datetime64[D]"),
            ("attr_number", np.float64),
        ]

        expected = [
            np.array(
                [("1999-01-31", 1), ("1935-11-27", 10)], dtype=dtype_instance
            ),
            np.array(
                [("2004-12-01", 2), ("1942-08-13", 20)], dtype=dtype_instance
            ),
