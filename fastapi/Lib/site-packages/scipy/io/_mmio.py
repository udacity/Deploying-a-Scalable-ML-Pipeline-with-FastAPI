...
class MMFile:
    ...
    # -------------------------------------------------------------------------
    def write(
        self, target, a, comment="", field=None, precision=None, symmetry=None
    ):
        """
    ...
    def _parse_header(self, stream):
        rows, cols, entries, format, field, symmetry = self.__class__.info(
            stream
        )
        self._init_attrs(
            rows=rows,
        ...
        if format == self.FORMAT_ARRAY:
            ...
            for line in stream:
                ...
                if entry_number + 1 > entries:
                    raise ValueError(
                        "'entries' in header is smaller than "
                        "number of entries"
                    )
                l = line.split()
    ...
    #  ------------------------------------------------------------------------
    def _write(
        self, stream, a, comment="", field=None, precision=None, symmetry=None
    ):
        if (
            isinstance(a, list)
