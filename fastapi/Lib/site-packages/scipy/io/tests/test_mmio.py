...
class TestMMIOArray:
    ...
    def test_32bit_integer(self, typeval, dtype):
        a = array(
            [[2**31 - 1, 2**31 - 2], [2**31 - 3, 2**31 - 4]], dtype=dtype
        )
    ...
    def test_simple_rectangular_float(self):
        self.check(
            [[1, 2], [3.5, 4], [5, 6]], (3, 2, 6, "array", "real", "general")
        )
...
class TestMMIOReadLargeIntegers:
    ...
    def check_read(self, example, a, info, dense, over32, over64):
        ...
        if (
            ...
            and mmwrite == scipy.io._mmio.mmwrite
        ) or over64:
...
class TestMMIOCoordinate:
    ...
    def test_read_general(self):
        ...
        self.check_read(
            _general_example, a, (5, 5, 8, "coordinate", "real", "general")
        )
    ...
    def test_empty_write_read(self):
        ...
        assert_equal(
            mminfo(self.fn), (10, 10, 0, "coordinate", "real", "symmetric")
        )
        a = b.toarray()
        b = mmread(self.fn).toarray()
        assert_array_almost_equal(a, b)
    ...
    def test_real_write_read(self):
        ...
        assert_equal(
            mminfo(self.fn), (5, 5, 8, "coordinate", "real", "general")
        )
        a = b.toarray()
        b = mmread(self.fn).toarray()
        assert_array_almost_equal(a, b)
    ...
    def test_complex_write_read(self):
        ...
        assert_equal(
            mminfo(self.fn), (5, 5, 8, "coordinate", "complex", "general")
        )
        a = b.toarray()
        b = mmread(self.fn).toarray()
        assert_array_almost_equal(a, b)
