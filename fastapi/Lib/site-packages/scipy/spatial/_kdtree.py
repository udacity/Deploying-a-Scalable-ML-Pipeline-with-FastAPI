...
def minkowski_distance_p(x, y, p=2):
    ...
    common_datatype = np.promote_types(
        np.promote_types(x.dtype, y.dtype), "float64"
    )
...
class Rectangle:
    ...
    def max_distance_point(self, x, p=2.0):
        ...
        """
        return minkowski_distance(
            0, np.maximum(self.maxes - x, x - self.mins), p
        )
    ...
    def min_distance_rectangle(self, other, p=2.0):
        ...
        return minkowski_distance(
            0,
            np.maximum(
                0, np.maximum(self.mins - other.maxes, other.mins - self.maxes)
            ),
            p,
        )
