    ...
    *Note*: The first two arguments of ``f(t, y, ...)`` are in the
    ...
    def set_integrator(self, name, **integrator_params):
        ...
        **integrator_params
        ...
        if integrator is None:
            ...
            # any code?
            message = (
                f"No integrator name match with {name!r} or is not available."
            )
    ...
    def set_solout(self, solout):
        ...
        if self._integrator.supports_solout:
            ...
            raise ValueError(
                "selected integrator does not support solout,"
                " choose another one"
            )
...
class complex_ode(ode):
    ...
    def set_solout(self, solout):
        ...
        if self._integrator.supports_solout:
            ...
            raise TypeError(
                "selected integrator does not support solouta, "
                "choose another one"
            )
        ...
        if has_jac:
            ...
            if jac_is_banded:
                if self.ml == self.mu == 0:
                    miter = (
                        3  # Chord iteration with internal diagonal Jacobian.
                    )
                else:
