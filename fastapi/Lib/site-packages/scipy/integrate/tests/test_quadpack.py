...
class TestCtypesQuad:
    ...
    def test_ctypes_variants(self):
        ...
        sin_2 = get_clib_test_routine(
            "_sin_2", ctypes.c_double, ctypes.c_double
        )
...
class TestMultivariateCtypesQuad:
    ...
    def test_typical(self):
        ...
        assert_quad(
            quad(self._multivariate_typical, 0, pi, (2, 1.8)),
    ...
    def test_indefinite(self):
        ...
        assert_quad(
            quad(self._multivariate_indefinite, 0, np.inf),
...
class TestQuad:
    ...
    def test_singular(self):
        ...
        assert_quad(
            quad(myfunc, 0, 10, points=[2.5, 5.0]),
    ...
    def test_sine_weighted_finite(self):
        ...
        assert_quad(
            ...
            (20 * sin(ome) - ome * cos(ome) + ome * exp(-20))
            / (20**2 + ome**2),
        )
    ...
    def test_complex(self):
        ...
        assert np.allclose(
            quad(tfunc, 0, np.pi / 2, complex_func=True)[0], 1 + 1j
        )
        ...
        res_r = quad(
            lambda x: np.real(np.exp(1j * x)), complex_func=False, **kwargs
        )
        res_i = quad(
            lambda x: np.imag(np.exp(1j * x)), complex_func=False, **kwargs
        )
...
class TestNQuad:
    ...
    def test_dict_as_opts(self):
        try:
            nquad(
                lambda x, y: x * y, [[0, 1], [0, 1]], opts={"epsrel": 0.0001}
            )
        except TypeError:
            assert False
