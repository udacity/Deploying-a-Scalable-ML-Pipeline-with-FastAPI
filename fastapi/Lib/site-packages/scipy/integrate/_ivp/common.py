...
class OdeSolution:
    ...
    def __init__(self, ts, interpolants, alt_segment=False):
        ...
        if ts.shape != (self.n_segments + 1,):
            raise ValueError(
                "Numbers of time stamps and interpolants " "don't match."
            )
...
def num_jac(fun, t, y, f, threshold, factor, sparsity=None):
    ...
    if sparsity is None:
        ...
        return _sparse_num_jac(
            fun, t, y, f, h, factor, y_scale, structure, groups
        )
...
def _sparse_num_jac(fun, t, y, f, h, factor, y_scale, structure, groups):
    ...
    if np.any(diff_too_small):
        ...
        diff_new = coo_matrix(
            (df[i, groups_map[groups[ind[j]]]], (i, j)),
            shape=(n, ind.shape[0]),
        ).tocsc()
