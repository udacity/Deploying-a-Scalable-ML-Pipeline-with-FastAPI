...
def quad(
    ...
    **Integration of Complex Function of a Real Variable**
    ...
    if weight is None:
        retval = _quad(
            func, a, b, args, full_output, epsabs, epsrel, limit, points
        )
    else:
...
def tplquad(
    ...
    **Details of QUADPACK level routines**
    ...
    return nquad(
        func, ranges, args=args, opts={"epsabs": epsabs, "epsrel": epsrel}
    )
...
class _NQuad:
    ...
    def integrate(self, *args, **kwargs):
        ...
        quad_r = quad(
            f, low, high, args=args, full_output=self.full_output, **opt
        )
        value = quad_r[0]
        abserr = quad_r[1]
        if self.full_output:
