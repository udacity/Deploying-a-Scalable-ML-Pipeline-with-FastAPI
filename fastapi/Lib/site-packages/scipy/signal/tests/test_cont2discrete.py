...
class TestC2D:
    ...
    def test_impulse(self):
        ...
        ad, bd, cd, dd, dt = c2d(
            (ac, bc, cc, dc), dt_requested, method="impulse"
        )
    ...
    def test_euler(self):
        ...
        ad, bd, cd, dd, dt = c2d(
            (ac, bc, cc, dc), dt_requested, method="euler"
        )
    ...
    def test_backward_diff(self):
        ...
        ad, bd, cd, dd, dt = c2d(
            (ac, bc, cc, dc), dt_requested, method="backward_diff"
        )
    ...
    def test_bilinear(self):
        ...
        dd_truth = np.array(
            [[0.291666666666667], [1.0 / 3.0], [-0.121666666666667]]
        )

        ad, bd, cd, dd, dt = c2d(
            (ac, bc, cc, dc), dt_requested, method="bilinear"
        )
    ...
    def test_zerospolesgain(self):
        ...
        zeros, poles, k, dt = c2d(
            (zeros_c, poles_c, k_c), dt_requested, method="zoh"
        )
