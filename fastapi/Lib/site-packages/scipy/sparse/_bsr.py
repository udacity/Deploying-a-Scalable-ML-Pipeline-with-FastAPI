...
class _bsr_base(_cs_matrix, _minmax_mixin):
    ...
    def __init__(
        self, arg1, shape=None, dtype=None, copy=False, blocksize=None
    ):
        ...
        if issparse(arg1):
            ...
            arg1 = self._coo_container(arg1, dtype=dtype).tobsr(
                blocksize=blocksize
            )
            self.indptr, self.indices, self.data, self._shape = (
                arg1.indptr,
        ...
        if shape is not None:
            ...
            if self.shape is None:
                ...
                try:
                    ...
                    raise ValueError(
                        "unable to infer matrix dimensions"
                    ) from e
                else:
                    R, C = self.blocksize
    ...
    def transpose(self, axes=None, copy=False):
        ...
        return self._bsr_container(
            (data, indices, indptr), shape=(N, M), copy=copy
        )
    ...
    def eliminate_zeros(self):
        ...
        mask = (
            (self.data != 0).reshape(-1, R * C).sum(axis=1)
        )  # nonzero blocks
