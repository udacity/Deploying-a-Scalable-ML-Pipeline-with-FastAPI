...
class _data_matrix(_spbase):
    ...
    def __round__(self, ndigits=0):
        return self._with_data(
            np.around(self._deduped_data(), decimals=ndigits)
        )
...
class _minmax_mixin:
    ...
    def _min_or_max_axis(self, axis, min_or_max):
        ...
        if isinstance(self, sparray):
            ...
            return self._coo_container(
                (value, coords), shape=shape, dtype=self.dtype
            )
    ...
    def _arg_min_or_max(self, axis, out, argmin_or_argmax, compare):
        ...
        if compare(extreme_value, zero):
            ...
            return int(mat.row[extreme_index]) * num_col + int(
                mat.col[extreme_index]
            )
