...
def _sub_module_deprecation(
    *,
    ...
    for module in private_modules:
        try:
            return getattr(
                import_module(f"scipy.{sub_package}.{module}"), attribute
            )
...
def _deprecated(msg, stacklevel=2):
    ...
    def wrap(fun):
        ...
        def call(*args, **kwargs):
            warnings.warn(
                msg, category=DeprecationWarning, stacklevel=stacklevel
            )
...
class _DeprecationHelperStr:
    ...
    def __eq__(self, other):
        ...
        if res:
            warnings.warn(
                self._message, category=DeprecationWarning, stacklevel=2
            )
        return res
