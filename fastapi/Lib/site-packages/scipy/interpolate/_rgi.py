...
class RegularGridInterpolator:
    ...
    **Interpolate and extrapolate a 2D dataset**
    ...
    def _evaluate_spline(self, xi, method):
        ...
        # last variable of xi.
        last_dim = n - 1
        first_values = _eval_func(
            self.grid[last_dim], values, xi[:, last_dim], k
        )
        ...
        for j in range(m):
            ...
            for i in range(last_dim - 1, -1, -1):
                ...
                folded_values = _eval_func(
                    self.grid[i], folded_values, xi[j, i], k
                )
...
def interpn(
    points, values, xi, method="linear", bounds_error=True, fill_value=np.nan
):
    """
