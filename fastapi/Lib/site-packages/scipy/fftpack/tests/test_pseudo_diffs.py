...
class TestDiff:
    ...
    def test_definition(self):
        for n in [16, 17, 64, 127, 32]:
            ...
            assert_array_almost_equal(
                diff(cos(2 * x)), direct_diff(cos(2 * x))
            )
            assert_array_almost_equal(
    ...
    def test_definition(self):
        for h in [0.1, 0.5, 1, 5.5, 10]:
            for n in [16, 17, 64, 127]:
                ...
                assert_array_almost_equal(
                    tilbert(sin(x), h), direct_tilbert(sin(x), h)
                )
                assert_array_almost_equal(
...
class TestHilbert:
    ...
    def test_definition(self):
        for n in [16, 17, 64, 127]:
            ...
            assert_array_almost_equal(y, y1)
            assert_array_almost_equal(
                hilbert(sin(2 * x)), direct_hilbert(sin(2 * x))
            )
...
class TestIHilbert:
    ...
    def test_definition(self):
        for n in [16, 17, 64, 127]:
            ...
            assert_array_almost_equal(y, y1)
            assert_array_almost_equal(
                ihilbert(sin(2 * x)), direct_ihilbert(sin(2 * x))
            )
    ...
    def test_definition(self):
        for n in [18, 17, 64, 127, 32, 2048, 256]:
            ...
            for a in [0.1, 3]:
                ...
                assert_array_almost_equal(
                    shift(cos(2 * x) + sin(x), a),
                    cos(2 * (x + a)) + sin(x + a),
                )
                assert_array_almost_equal(
                    shift(exp(sin(x)), a), exp(sin(x + a))
                )
