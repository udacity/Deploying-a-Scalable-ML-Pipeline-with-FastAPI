        ...
        for type in [1, 2, 3, 4]:
            for overwrite_x in [True, False]:
                for norm in [None, "ortho"]:
                    self._check(
                        data, routine, type, None, axis, norm, overwrite_x
                    )
...
class Test_DCTN_IDCTN:
    ...
    @pytest.mark.parametrize(
        "fforward,finverse", [(dctn, idctn), (dstn, idstn)]
    )
    @pytest.mark.parametrize(
        "axes",
        [None, 1, (1,), [1], 0, (0,), [0], (0, 1), [0, 1], (-2, -1), [-2, -1]],
    )
    ...
    def test_dctn_vs_2d_reference(
        self, fforward, fforward_ref, dct_type, norm
    ):
    ...
    def test_idctn_vs_2d_reference(
        self, finverse, finverse_ref, dct_type, norm
    ):
