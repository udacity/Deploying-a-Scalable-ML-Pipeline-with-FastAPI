    ...
    def expect(self, func=None, lb=None, ub=None, conditional=False, **kwds):
        ...
        if isinstance(self.dist, rv_discrete):
            ...
            return self.dist.expect(
                func, a, loc, scale, lb, ub, conditional, **kwds
            )
    ...
    def stats(self, *args, **kwds):
        ...
        if np.any(cond):
            ...
            if self._stats_has_moments:
                mu, mu2, g1, g2 = self._stats(
                    *goodargs, **{"moments": moments}
                )
            else:
        ...
        *shapes, loc, scale = args
        ...
        if i2.any():
            ...
            *shapes, loc, scale, val = args
            ...
            fac = scale / loc
            for k in range(n):
                valk = _moment_from_stats(
                    k, mu, mu2, g1, g2, self._munp, shapes
                )
...
class rv_continuous(rv_generic):
    ...
    **Deepcopying / Pickling**
    ...
    def logcdf(self, x, *args, **kwds):
        ...
        output.fill(-inf)
        place(
            output, (1 - cond0) * (cond1 == cond1) + np.isnan(x), self.badvalue
        )
    ...
    def _reduce_func(self, args, kwds, data=None):
        ...
        if method == "mm":
            ...
            data_moments = np.sum(
                data[None, :] ** exponents / len(data), axis=1
            )
    ...
    def _moment_error(self, theta, x, data_moments):
        ...
        return (
            (
                ...
                / np.maximum(np.abs(data_moments), 1e-8)
            )
            ** 2
        ).sum()
    ...
    def fit(self, data, *args, **kwds):
        ...
        **kwds : floats, optional
        ...
        if censored:
            if method != "mle":
                raise ValueError(
                    "For censored data, the method must" ' be "MLE".'
                )
...
class rv_discrete(rv_generic):
    ...
    **Deepcopying / Pickling**
    ...
    def expect(
        ...
        res = _expect(
            fun, lb, ub, x0, self.inc, maxcount, tolerance, chunksize
        )
        return res / invfac
...
def _check_shape(argshape, size):
    ...
    scalar_shape = []
    bc = []
    for argdim, sizedim in zip_longest(
        argshape[::-1], size[::-1], fillvalue=1
    ):
