...
class betanbinom_gen(rv_discrete):
    ...
    def _stats(self, n, a, b, moments="mv"):
        ...
        def kurtosis(n, a, b):
            ...
            denominator = (
                (a - 4.0) * (a - 3.0) * b * n * (a + b - 1.0) * (a + n - 1.0)
            )
...
randint = randint_gen(
    name="randint", longname="A discrete uniform " "(random integer)"
)
...
def _gen_harmonic(n, a):
    ...
    return _lazywhere(
        a > 1, (n, a), f=_gen_harmonic_gt1, f2=_gen_harmonic_leq1
    )
...
dlaplace = dlaplace_gen(
    a=-np.inf, name="dlaplace", longname="A discrete Laplacian"
)
