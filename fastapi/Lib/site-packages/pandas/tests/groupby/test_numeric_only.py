...
class TestNumericOnly:
    ...
    def _check(self, df, method, expected_columns, expected_columns_numeric):
        ...
        exception = (
            NotImplementedError if method.startswith("cum") else TypeError
        )
...
def test_axis1_numeric_only(
    request, groupby_func, numeric_only, using_infer_string
):
...
def test_numeric_only(kernel, has_arg, numeric_only, keys):
    ...
    if has_arg and numeric_only is True:
        ...
        or (
            ...
            kernel
            in ("any", "all", "bfill", "ffill", "fillna", "nth", "nunique")
