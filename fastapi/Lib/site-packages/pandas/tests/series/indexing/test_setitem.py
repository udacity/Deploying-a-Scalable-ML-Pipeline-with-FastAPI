...
class TestSetitemViewCopySemantics:
    ...
    def test_dt64tz_setitem_does_not_mutate_dti(self, using_copy_on_write):
        ...
        if using_copy_on_write:
            ...
            assert ser._values._ndarray.base is not dti._data._ndarray.base
            assert (
                ser._mgr.arrays[0]._ndarray.base is not dti._data._ndarray.base
            )
...
class SetitemCastingEquivalents:
    ...
    def test_int_key(
        self, obj, key, expected, warn, val, indexer_sli, is_inplace
    ):
    ...
    def test_index_where(
        self, obj, key, expected, warn, val, using_infer_string
    ):
        mask = np.zeros(obj.shape, dtype=bool)
        mask[key] = True
        ...
        pytest.param(
            ...
            marks=pytest.mark.xfail(
                (
                    ...
                    or (
                        np_version_gte1p24
                        and np._get_promotion_state() != "weak"
                    )
                ),
...
class TestCoercionFloat32(CoercionTest):
    ...
    def test_slice_key(
        ...
        super().test_slice_key(
            obj, key, expected, warn, val, indexer_sli, is_inplace
        )
