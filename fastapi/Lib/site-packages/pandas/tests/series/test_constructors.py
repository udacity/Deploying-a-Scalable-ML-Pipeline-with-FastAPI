...
class TestSeriesConstructors:
    ...
    def test_constructor(self, datetime_series, using_infer_string):
        ...
        assert (
            mixed.dtype == np.object_ if not using_infer_string else "string"
        )
    ...
    def test_constructor_periodindex(self):
        ...
        with tm.assert_produces_warning(
            FutureWarning, match="Dtype inference"
        ):
    ...
    def test_fromDict(self, using_infer_string):
        ...
        series = Series(data)
        assert (
            series.dtype == np.object_ if not using_infer_string else "string"
        )
    ...
    def test_fromValue(self, datetime_series, using_infer_string):
        ...
        assert (
            strings.dtype == np.object_ if not using_infer_string else "string"
        )
