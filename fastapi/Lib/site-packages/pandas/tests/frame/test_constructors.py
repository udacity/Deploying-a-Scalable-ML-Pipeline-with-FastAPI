...
class TestDataFrameConstructors:
    ...
    @pytest.mark.xfail(
        using_pyarrow_string_dtype(), reason="conversion copies"
    )
    ...
    def test_constructor_with_datetimes3(self):
        ...
        tm.assert_series_equal(
            df.dtypes,
            Series({"End Date": "datetime64[ns, US/Eastern]"}, dtype=object),
        )
