...
class TestTZLocalize:
    ...
    def test_dti_tz_localize_ambiguous_infer(self, tz):
        ...
        with pytest.raises(
            pytz.AmbiguousTimeError, match="Cannot infer dst time"
        ):
            dr.tz_localize(tz)
    ...
    def test_dti_tz_localize_ambiguous_times(self, tz):
        ...
        with pytest.raises(
            pytz.NonExistentTimeError, match="2011-03-13 02:30:00"
        ):
            dr.tz_localize(tz)
    ...
    def test_dti_tz_localize(self, prefix):
        ...
        with pytest.raises(
            pytz.NonExistentTimeError, match="2011-03-13 02:00:00"
        ):
            dti.tz_localize(tzstr)
    ...
    def test_dti_tz_localize_utc_conversion(self, tz):
        ...
        with pytest.raises(
            pytz.NonExistentTimeError, match="2012-03-11 02:00:00"
        ):
            rng.tz_localize(tz)
