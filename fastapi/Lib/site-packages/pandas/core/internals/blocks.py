...
class Block(PandasObject, libinternals.Block):
    ...
    def coerce_to_target_dtype(
        self, other, warn_on_upcast: bool = False
    ) -> Block:
        """
    ...
    def _maybe_downcast(
        ...
        if self.dtype == _dtype_obj:
            ...
            caller == "where"
            and get_option("future.no_silent_downcasting") is True
        ):
            return blocks
        else:
            nbs = extend_blocks(
            ...
            for blk_num, blk in enumerate(rb):
                ...
                if (
                    ...
                    for res_blk in result:
                        ...
                        if (
                            len(converted) > 1
                            or converted[0].dtype != res_blk.dtype
                        ):
                            warnings.warn(
                                # GH#54710
