...
class BaseBlockManager(DataManager):
    ...
    def astype(
        self, dtype, copy: bool | None = False, errors: str = "raise"
    ) -> Self:
        if copy is None:
    ...
    def convert(self, copy: bool | None) -> Self:
        ...
        return self.apply(
            "convert", copy=copy, using_cow=using_copy_on_write()
        )
...
class BlockManager(libinternals.BlockManager, BaseBlockManager):
    ...
    def iset(
        ...
        for blkno_l, val_locs in libinternals.get_blkno_placements(
            ...
            if inplace and blk.should_store(value):
                ...
                if using_copy_on_write() and not self._has_no_reference_block(
                    blkno_l
                ):
    ...
    def _insert_update_blklocs_and_blknos(self, loc) -> None:
        ...
        if loc == self.blklocs.shape[0]:
            ...
            self._blknos = np.append(self._blknos[::-1], len(self.blocks))[
                ::-1
            ]
        else:
