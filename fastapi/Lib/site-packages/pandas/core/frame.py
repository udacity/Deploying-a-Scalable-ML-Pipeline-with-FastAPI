...
class DataFrame(NDFrame, OpsMixin):
    ...
    @deprecate_nonkeyword_arguments(
        version="3.0",
        allowed_args=["self", "destination_table"],
        name="to_gbq",
    )
    def to_gbq(
        self,
        ...
        **Non-square DataFrame with mixed dtypes**
        ...
        if self._can_fast_transpose:
            ...
            if isinstance(dtypes[0], BaseMaskedDtype):
                ...
                values = self.values
                new_values = [
                    arr_typ._from_sequence(row, dtype=dtyp) for row in values
                ]
    ...
    def _ixs(self, i: int, axis: AxisInt = 0) -> Series:
        ...
        if axis == 0:
            ...
            copy = (
                isinstance(new_mgr.array, np.ndarray)
                and new_mgr.array.base is None
            )
    ...
    def value_counts(
        ...
        counts = self.groupby(
            subset, dropna=dropna, observed=False
        )._grouper.size()
        counts.name = name
