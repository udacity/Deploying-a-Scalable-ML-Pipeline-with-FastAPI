...
class NDFrame(PandasObject, indexing.IndexingMixin):
    ...
    @final
    def swapaxes(
        self, axis1: Axis, axis2: Axis, copy: bool_t | None = None
    ) -> Self:
        """
    ...
    def _rename(
        ...
        *,
        ...
        result = (
            self
            if inplace
            else self.copy(deep=copy and not using_copy_on_write())
        )
    ...
    def _take_with_is_copy(self, indices, axis: Axis = 0) -> Self:
        ...
        if self.ndim == 2 and not result._get_axis(axis).equals(
            self._get_axis(axis)
        ):
    ...
    def _check_setitem_copy(self, t: str = "setting", force: bool_t = False):
        ...
        if value == "warn":
            warnings.warn(
                t, SettingWithCopyWarning, stacklevel=find_stack_level()
            )
    ...
    def _needs_reindex_multi(
        self, axes, method, level: Level | None
    ) -> bool_t:
    ...
    def astype(
        ...
        if is_dict_like(dtype):
            ...
            results = [
                ser.astype(dtype, copy=copy, errors=errors)
    ...
    def replace(
        ...
        *,
        ...
        regex: bool_t = False,
        method: (
            Literal["pad", "ffill", "bfill"] | lib.NoDefault
        ) = lib.no_default,
    ) -> Self | None:
    ...
    @final
    def at_time(
        self, time, asof: bool_t = False, axis: Axis | None = None
    ) -> Self:
        """
    ...
    def resample(
        ...
        kind: (
            Literal["timestamp", "period"] | None | lib.NoDefault
        ) = lib.no_default,
        on: Level | None = None,
        level: Level | None = None,
    ...
    def pct_change(
        ...
        **DataFrame**
        ...
        # GH#53491
        if (
            fill_method not in (lib.no_default, None)
            or limit is not lib.no_default
        ):
            warnings.warn(
    ...
    def expanding(
        ...
        if axis is not lib.no_default:
            ...
            axis = 0
        return Expanding(
            self, min_periods=min_periods, axis=axis, method=method
        )
