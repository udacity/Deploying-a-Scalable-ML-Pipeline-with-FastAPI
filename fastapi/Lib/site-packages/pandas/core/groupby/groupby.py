    ...
    **Attributes**
    ...
    def _op_via_apply(self, name: str, *args, **kwargs):
        ...
        if "axis" in sig.parameters:
            if (
                kwargs.get("axis", None) is None
                or kwargs.get("axis") is lib.no_default
            ):
    ...
    def apply(
        self, func, *args, include_groups: bool = True, **kwargs
    ) -> NDFrameT:
        orig_func = func
        ...
        with option_context("mode.chained_assignment", None):
            try:
                ...
                if (
                    ...
                    and self._selected_obj.shape
                    != self._obj_with_exclusions.shape
                ):
                    warnings.warn(
    ...
    def _value_counts(
        ...
        if any(
            isinstance(
                grouping.grouping_vector, (Categorical, CategoricalIndex)
            )
    ...
    @final
    def resample(
        self, rule, *args, include_groups: bool = True, **kwargs
    ) -> Resampler:
        """
    ...
    def _fill(
        ...
        ids, _, _ = self._grouper.group_info
        sorted_labels = np.argsort(ids, kind="mergesort").astype(
            np.intp, copy=False
        )
        if direction == "bfill":
