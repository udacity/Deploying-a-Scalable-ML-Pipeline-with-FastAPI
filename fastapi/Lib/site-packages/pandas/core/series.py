...
class Series(base.IndexOpsMixin, NDFrame):  # type: ignore[misc]
    ...
    def _set_name(
        ...
        inplace = validate_bool_kwarg(inplace, "inplace")
        ser = (
            self if inplace else self.copy(deep and not using_copy_on_write())
        )
        ser.name = name
        return ser
    ...
    def to_period(
        self, freq: str | None = None, copy: bool | None = None
    ) -> Series:
        """
    ...
    def sum(
        ...
        **kwargs,
        ...
        return NDFrame.sum(
            self, axis, skipna, numeric_only, min_count, **kwargs
        )
