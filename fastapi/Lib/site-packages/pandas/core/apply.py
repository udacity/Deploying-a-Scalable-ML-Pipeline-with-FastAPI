...
class Apply(metaclass=abc.ABCMeta):
    ...
    def _apply_str(self, obj, func: str, *args, **kwargs):
        ...
        if hasattr(obj, func):
            ...
            assert len(args) == 0
            assert (
                len([kwarg for kwarg in kwargs if kwarg not in ["axis"]]) == 0
            )
            return f
...
class FrameRowApply(FrameApply):
    ...
    def apply_with_numba(self) -> dict[int, Any]:
        ...
        with set_numba_data(index) as index, set_numba_data(
            columns
        ) as columns:
    ...
    def agg(self):
        ...
        if result is None:
            ...
            try:
                ...
                warnings.warn(
                    msg, FutureWarning, stacklevel=find_stack_level()
                )
