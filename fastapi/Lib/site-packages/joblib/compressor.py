...
LZ4_NOT_INSTALLED_ERROR = (
    "LZ4 is not installed. Install it with pip: "
...
def register_compressor(compressor_name, compressor, force=False):
    ...
    if not isinstance(compressor_name, str):
        raise ValueError(
            "Compressor name should be a string, "
    ...
    def compressor_file(self, fileobj, compresslevel=None):
        ...
        if compresslevel is None:
            ...
            return self.fileobj_factory(
                fileobj, "wb", compresslevel=compresslevel
            )
...
class BZ2CompressorWrapper(CompressorWrapper):
    ...
    def _check_versions(self):
        if bz2 is None:
            raise ValueError(
                "bz2 module is not compiled on your python "
                "standard library."
            )
...
class LZMACompressorWrapper(CompressorWrapper):
    ...
    def _check_versions(self):
        if lzma is None:
            raise ValueError(
                "lzma module is not compiled on your python "
                "standard library."
            )
    ...
    def compressor_file(self, fileobj, compresslevel=None):
        ...
        if compresslevel is None:
            return self.fileobj_factory(
                fileobj, "wb", format=self._lzma_format
            )
        else:
            return self.fileobj_factory(
...
class LZ4CompressorWrapper(CompressorWrapper):
    ...
    def compressor_file(self, fileobj, compresslevel=None):
        ...
        if compresslevel is None:
            ...
            return self.fileobj_factory(
                fileobj, "wb", compression_level=compresslevel
            )
