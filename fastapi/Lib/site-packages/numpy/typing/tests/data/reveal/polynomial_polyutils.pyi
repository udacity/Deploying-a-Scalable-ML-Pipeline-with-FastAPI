...
assert_type(
    pu.mapparms(seq_sct_float, seq_sct_float), _Tuple2[np.floating[Any]]
)
assert_type(
    pu.mapparms(seq_sct_float, seq_sct_complex),
    _Tuple2[np.complexfloating[Any, Any]],
)
assert_type(
    pu.mapparms(seq_sct_complex, seq_sct_complex),
    _Tuple2[np.complexfloating[Any, Any]],
)
...
assert_type(
    pu.mapparms(arr_float, arr_complex), _Tuple2[np.complexfloating[Any, Any]]
)
assert_type(
    pu.mapparms(arr_complex, arr_complex),
    _Tuple2[np.complexfloating[Any, Any]],
)
...
assert_type(
    pu.mapdomain(num_int, seq_num_int, seq_num_float), np.floating[Any]
)
assert_type(
    pu.mapdomain(num_int, seq_num_float, seq_num_float), np.floating[Any]
)
assert_type(
    pu.mapdomain(num_float, seq_num_float, seq_num_float), np.floating[Any]
)
assert_type(
...
assert_type(
    pu.mapdomain(seq_num_int, seq_num_float, seq_num_float), _ArrFloat1D
)
assert_type(
    pu.mapdomain(seq_num_float, seq_num_float, seq_num_float), _ArrFloat1D
)
assert_type(
    pu.mapdomain(seq_num_float, seq_num_float, seq_num_complex), _ArrComplex1D
)
assert_type(
    pu.mapdomain(seq_num_float, seq_num_complex, seq_num_complex),
    _ArrComplex1D,
)
assert_type(
    pu.mapdomain(seq_num_complex, seq_num_complex, seq_num_complex),
    _ArrComplex1D,
)
assert_type(
    pu.mapdomain(seq_num_complex, seq_num_complex, seq_num_object),
    _ArrObject1D,
)
assert_type(
    pu.mapdomain(seq_num_complex, seq_num_object, seq_num_object), _ArrObject1D
)
assert_type(
    pu.mapdomain(seq_num_object, seq_num_object, seq_num_object), _ArrObject1D
)
...
assert_type(
    pu.mapdomain(seq_sct_int, seq_sct_float, seq_sct_float), _ArrFloat1D
)
assert_type(
    pu.mapdomain(seq_sct_float, seq_sct_float, seq_sct_float), _ArrFloat1D
)
assert_type(
    pu.mapdomain(seq_sct_float, seq_sct_float, seq_sct_complex), _ArrComplex1D
)
assert_type(
    pu.mapdomain(seq_sct_float, seq_sct_complex, seq_sct_complex),
    _ArrComplex1D,
)
assert_type(
    pu.mapdomain(seq_sct_complex, seq_sct_complex, seq_sct_complex),
    _ArrComplex1D,
)
assert_type(
    pu.mapdomain(seq_sct_complex, seq_sct_complex, seq_sct_object),
    _ArrObject1D,
)
assert_type(
    pu.mapdomain(seq_sct_complex, seq_sct_object, seq_sct_object), _ArrObject1D
)
assert_type(
    pu.mapdomain(seq_sct_object, seq_sct_object, seq_sct_object), _ArrObject1D
)
