...
assert_type(
    np.char.endswith(AR_S, [b"a", b"b", b"c"], end=9), npt.NDArray[np.bool]
)
assert_type(
    np.char.startswith(AR_U, "a", start=[1, 2, 3]), npt.NDArray[np.bool]
)
assert_type(
    np.char.startswith(AR_S, [b"a", b"b", b"c"], end=9), npt.NDArray[np.bool]
)
...
assert_type(
    np.char.array(AR_S, order="K"), np.char.chararray[Any, np.dtype[np.bytes_]]
)
assert_type(
    np.char.array("bob", copy=True), np.char.chararray[Any, np.dtype[np.str_]]
)
assert_type(
...
assert_type(
    np.char.array(1, unicode=True), np.char.chararray[Any, np.dtype[np.str_]]
)
...
assert_type(
    np.char.asarray(1, unicode=True), np.char.chararray[Any, np.dtype[np.str_]]
)
