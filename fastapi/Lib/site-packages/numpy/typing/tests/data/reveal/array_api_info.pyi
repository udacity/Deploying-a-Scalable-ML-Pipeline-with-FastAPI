...
assert_type(
    info.dtypes(kind="unsigned integer")["uint64"], np.dtype[np.uint64]
)
...
assert_type(info.dtypes(kind=("integral",))["uint32"], np.dtype[np.uint32])
assert_type(
    info.dtypes(kind=("complex floating",))["complex128"],
...
assert_type(
    info.dtypes(kind=("integral", "real floating", "complex floating"))[
        "int16"
    ],
    np.dtype[np.int16],
)
