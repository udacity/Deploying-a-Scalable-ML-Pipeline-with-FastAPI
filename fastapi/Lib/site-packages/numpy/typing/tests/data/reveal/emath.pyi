...
assert_type(
    np.emath.logn(AR_c16, 1.5), npt.NDArray[np.complexfloating[Any, Any]]
)
...
assert_type(
    np.emath.power(AR_c16, 1.5), npt.NDArray[np.complexfloating[Any, Any]]
)
...
assert_type(
    np.emath.arctanh(AR_c16), npt.NDArray[np.complexfloating[Any, Any]]
)
