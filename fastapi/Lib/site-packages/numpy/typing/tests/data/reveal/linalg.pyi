...
assert_type(
    np.linalg.outer(AR_c16, AR_c16), npt.NDArray[np.complexfloating[Any, Any]]
)
...
assert_type(
    np.linalg.cross(AR_c16, AR_c16), npt.NDArray[np.complexfloating[Any, Any]]
)
...
assert_type(
    np.linalg.matmul(AR_c16, AR_c16), npt.NDArray[np.complexfloating[Any, Any]]
)
