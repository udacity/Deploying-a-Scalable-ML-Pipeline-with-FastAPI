...
_Ar_x_n: TypeAlias = np.ndarray[
    tuple[int], np.dtype[np.inexact[Any] | np.object_]
]
_Ar_f_n: TypeAlias = np.ndarray[tuple[int], np.dtype[np.floating[Any]]]
_Ar_c_n: TypeAlias = np.ndarray[
    tuple[int], np.dtype[np.complexfloating[Any, Any]]
]
_Ar_O_n: TypeAlias = np.ndarray[tuple[int], np.dtype[np.object_]]

_Ar_x_2: TypeAlias = np.ndarray[
    tuple[L[2]], np.dtype[np.inexact[Any] | np.object_]
]
_Ar_f_2: TypeAlias = np.ndarray[tuple[L[2]], np.dtype[np.floating[Any]]]
_Ar_c_2: TypeAlias = np.ndarray[
    tuple[L[2]], np.dtype[np.complexfloating[Any, Any]]
]
...
AR_c_co: (
    npt.NDArray[np.complex128] | npt.NDArray[np.float64] | npt.NDArray[np.int_]
)
...
assert_type(
    PS_poly.linspace(),
    tuple[
        _Ar_1d[np.float64 | np.complex128], _Ar_1d[np.float64 | np.complex128]
    ],
)
...
assert_type(
    PS_poly(SQ_c), npt.NDArray[np.complex128] | npt.NDArray[np.object_]
)
...
assert_type(
    PS_poly(AR_c), npt.NDArray[np.complex128] | npt.NDArray[np.object_]
)
