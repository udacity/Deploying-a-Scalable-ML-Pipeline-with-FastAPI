...
assert_type(
    def_gen.integers(I_bool_high_open, dtype=bool), npt.NDArray[np.bool]
)
assert_type(
...
assert_type(
    def_gen.integers(0, I_bool_high_open, dtype=bool), npt.NDArray[np.bool]
)
assert_type(
...
assert_type(
    def_gen.integers(I_bool_high_open, dtype=np.bool), npt.NDArray[np.bool]
)
assert_type(
...
assert_type(
    def_gen.integers(0, I_bool_high_open, dtype=np.bool), npt.NDArray[np.bool]
)
assert_type(
...
assert_type(
    def_gen.integers(
        I_bool_low, I_bool_high_closed, dtype=np.bool, endpoint=True
    ),
    npt.NDArray[np.bool],
)
assert_type(
...
assert_type(
    def_gen.integers(0, 65535, dtype="uint16", endpoint=True), np.uint16
)
assert_type(
...
assert_type(
    def_gen.integers(0, 65535, dtype=np.uint16, endpoint=True), np.uint16
)
assert_type(
...
I_u4_high_open: npt.NDArray[np.uint32] = np.array(
    [4294967295], dtype=np.uint32
)
I_u4_high_closed: npt.NDArray[np.uint32] = np.array(
    [4294967295], dtype=np.uint32
)
...
assert_type(
    def_gen.integers(4294967295, dtype=np.int_, endpoint=True), np.int_
)
assert_type(
    def_gen.integers(0, 4294967295, dtype=np.int_, endpoint=True), np.int_
)
assert_type(
...
assert_type(
    def_gen.integers(0, 4294967295, dtype="u4", endpoint=True), np.uint32
)
assert_type(
...
assert_type(
    def_gen.integers(4294967295, dtype="uint32", endpoint=True), np.uint32
)
assert_type(
    def_gen.integers(0, 4294967295, dtype="uint32", endpoint=True), np.uint32
)
assert_type(
...
assert_type(
    def_gen.integers(4294967295, dtype=np.uint32, endpoint=True), np.uint32
)
assert_type(
    def_gen.integers(0, 4294967295, dtype=np.uint32, endpoint=True), np.uint32
)
assert_type(
    def_gen.integers(
...
assert_type(
    def_gen.integers(4294967295, dtype=np.uint, endpoint=True), np.uint
)
assert_type(
    def_gen.integers(0, 4294967295, dtype=np.uint, endpoint=True), np.uint
)
assert_type(
...
assert_type(
    def_gen.integers(0, 18446744073709551616, dtype="uint64"), np.uint64
)
assert_type(
...
assert_type(
    def_gen.integers(0, 18446744073709551616, dtype=np.uint64), np.uint64
)
assert_type(
...
assert_type(
    def_gen.integers(-32768, 32767, dtype="i2", endpoint=True), np.int16
)
assert_type(
...
assert_type(
    def_gen.integers(-32768, 32767, dtype="int16", endpoint=True), np.int16
)
assert_type(
...
assert_type(
    def_gen.integers(-32768, 32767, dtype=np.int16, endpoint=True), np.int16
)
assert_type(
...
I_i4_high_closed: npt.NDArray[np.int32] = np.array(
...
assert_type(
    def_gen.integers(2147483647, dtype="int32", endpoint=True), np.int32
)
assert_type(
...
assert_type(
    def_gen.integers(-2147483648, 2147483648, dtype=np.int32), np.int32
)
assert_type(
    def_gen.integers(2147483647, dtype=np.int32, endpoint=True), np.int32
)
assert_type(
...
I_i8_low: npt.NDArray[np.int64] = np.array(
    [-9223372036854775808], dtype=np.int64
)
I_i8_low_like: list[int] = [-9223372036854775808]
I_i8_high_open: npt.NDArray[np.int64] = np.array(
...
assert_type(
    def_gen.integers(9223372036854775807, dtype="i8", endpoint=True), np.int64
)
assert_type(
    def_gen.integers(
...
assert_type(
    random_st.binomial(I_arr_like_10, D_arr_like_0p5), npt.NDArray[np.long]
)
assert_type(
    random_st.binomial(I_arr_10, D_arr_0p5, size=1), npt.NDArray[np.long]
)
assert_type(
...
assert_type(
    random_st.negative_binomial(I_arr_10, 0.5, size=1), npt.NDArray[np.long]
)
assert_type(
    random_st.negative_binomial(10, D_arr_0p5, size=1), npt.NDArray[np.long]
)
assert_type(
    random_st.negative_binomial(I_arr_like_10, 0.5), npt.NDArray[np.long]
)
assert_type(
    random_st.negative_binomial(10, D_arr_like_0p5), npt.NDArray[np.long]
)
assert_type(
    random_st.negative_binomial(I_arr_10, D_arr_0p5), npt.NDArray[np.long]
)
assert_type(
...
assert_type(
    random_st.hypergeometric(20, I_arr_20, 10, size=1), npt.NDArray[np.long]
)
assert_type(
    random_st.hypergeometric(I_arr_like_20, 20, I_arr_10), npt.NDArray[np.long]
)
assert_type(
    random_st.hypergeometric(20, I_arr_like_20, 10), npt.NDArray[np.long]
)
assert_type(
    random_st.hypergeometric(I_arr_20, I_arr_20, 10), npt.NDArray[np.long]
)
assert_type(
...
assert_type(
    random_st.randint(I_bool_high_open, dtype=bool), npt.NDArray[np.bool]
)
assert_type(
...
assert_type(
    random_st.randint(0, I_bool_high_open, dtype=bool), npt.NDArray[np.bool]
)

assert_type(random_st.randint(2, dtype=np.bool), np.bool)
assert_type(random_st.randint(0, 2, dtype=np.bool), np.bool)
assert_type(
    random_st.randint(I_bool_high_open, dtype=np.bool), npt.NDArray[np.bool]
)
assert_type(
...
assert_type(
    random_st.randint(0, I_bool_high_open, dtype=np.bool), npt.NDArray[np.bool]
)
...
assert_type(
    random_st.randint(0, 18446744073709551616, dtype="uint64"), np.uint64
)
assert_type(
...
assert_type(
    random_st.randint(18446744073709551616, dtype=np.uint64), np.uint64
)
assert_type(
    random_st.randint(0, 18446744073709551616, dtype=np.uint64), np.uint64
)
assert_type(
...
assert_type(
    random_st.randint(-2147483648, 2147483648, dtype="int32"), np.int32
)
assert_type(
...
assert_type(
    random_st.randint(-2147483648, 2147483648, dtype=np.int32), np.int32
)
assert_type(
...
assert_type(
    random_st.choice(5, 3, p=[1 / 5] * 5, replace=False), npt.NDArray[np.long]
)
...
assert_type(
    random_st.multinomial(20, np.array([0.5, 0.5])), npt.NDArray[np.long]
)
assert_type(
    random_st.multinomial(20, [1 / 6.0] * 6, size=2), npt.NDArray[np.long]
)
