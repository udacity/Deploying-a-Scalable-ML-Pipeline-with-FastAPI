...
_NdArraySubClass_co = TypeVar(
    "_NdArraySubClass_co", bound=NDArray[Any], covariant=True
)
...
class dtype(Generic[_DTypeScalar_co]):
    ...
    def newbyteorder(
        self: _DType, new_order: _ByteOrder = ..., /
    ) -> _DType: ...
    @property
...
_Shape2DType_co = TypeVar(
    "_Shape2DType_co", covariant=True, bound=tuple[int, int]
)
...
matmul: _GUFunc_Nin2_Nout1[
    L["matmul"], L[19], None, L["(n?,k),(k,m?)->(n?,m?)"]
]
...
class ndenumerate(Generic[_ScalarType_co]):
    ...
    def __next__(
        self: ndenumerate[
            np.bool | datetime64 | timedelta64 | number[Any] | flexible
        ],
        /,
...
class matrix(ndarray[_Shape2DType_co, _DType_co]):
    ...
    ) -> matrix[_Shape2DType_co, _DType_co]: ...
