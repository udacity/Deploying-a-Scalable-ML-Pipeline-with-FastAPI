...
_SeriesLikeBool_co: TypeAlias = (
    _SupportsArray[np.bool] | Sequence[bool | np.bool]
)
_SeriesLikeInt_co: TypeAlias = (
    _SupportsArray[np.integer[Any] | np.bool] | Sequence[_IntLike_co]
)
...
_SeriesLikeObject_co: TypeAlias = (
    _SupportsArray[np.object_] | Sequence[_CoefObjectLike_co]
)
