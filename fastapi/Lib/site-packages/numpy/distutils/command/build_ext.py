...
class build_ext(old_build_ext):
    ...
    def run(self):
        ...
        for ext in self.extensions:
            ...
            if macros:
                log.info(
                    "extending extension %r defined_macros with %r"
                    % (ext.name, macros)
                )
    ...
    def build_extension(self, ext):
        ...
        if self.inplace:
            ...
            ext_filename = os.path.join(
                package_dir, self.get_ext_filename(base)
            )
        else:
            ext_filename = os.path.join(
        ...
        if c_sources:
            ...
            c_objects += self.compiler.compile(
                ...
                debug=self.debug,
                extra_postargs=(
                    extra_args + copt_baseline_flags + extra_cflags
                ),
                **kws
            )
        if cxx_sources:
            ...
            c_objects += cxx_compiler.compile(
                ...
                debug=self.debug,
                extra_postargs=(
                    extra_args + copt_baseline_flags + extra_cxxflags
                ),
                **kws
            )
    ...
    def _libs_with_msvc_and_fortran(
