...
class _Test_CCompilerOpt:
    ...
    def test_skip(self):
        ...
        self.expect(
            "sse vsx neon", x86="sse", ppc64="vsx", armhf="neon", unknown=""
        )
        self.expect(
        ...
        self.expect(
            "sse neon vsx", baseline="sse neon vsx", x86="", ppc64="", armhf=""
        )
        self.expect(
            "avx2 vsx3 asimdhp",
    ...
    def test_args_options(self):
        ...
        self.expect(
            "min", trap_files=".*cpu_(sse2|vsx2).c", x86="", ppc64le=""
        )
