...
class LinuxCPUInfo(CPUInfoBase):
    ...
    def _is_Opteron(self):
        return (
            re.match(r".*?Opteron\b", self.info[0]["model name"]) is not None
        )
    ...
    def _is_PentiumPro(self):
        return (
            re.match(r".*?PentiumPro\b", self.info[0]["model name"])
            is not None
        )
...
class SunOSCPUInfo(CPUInfoBase):
    ...
    def _is_ultraenterprice(self):
        return (
            re.match(r".*Ultra-Enterprise", self.info["uname_i"]) is not None
        )
